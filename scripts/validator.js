...
class Validator {
  constructor() {
    ...
    this.invalidEmailError = "This email adress is invalid";
    this.emailExistsError = "This email adress is already used";
    this.passwordError = "Your password must be at least 6 characters long";
